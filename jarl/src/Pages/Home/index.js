      ...
      <section className="Home">
        <article className="Home-grid">
          <div className="Home-about">
            <h1 className="Home-title">Alejandro Rivas</h1>
            {/*<aside className="Home-tags">
              <span>FrontEnd</span> / <span>Backend</span> / <span>DevOps</span>
            </aside>*/}
            <p className="Home-description">
              Hola soy Alejandro Rivas, un desarrollador web fullStack ecuatoriono de 22 años.
              Me gusta resolver problemas de diseño, crear una interfaz de usuario inteligente e imaginar una interacción útil, desarrollando experiencias web ricas y aplicaciones web . 
              Cuando no estoy trabajando o divagando con el código, veo series, peliculas o practica algun deporte que me guste
            </p>
          </div>
          <div className="Home-logo">
            <p className="Home-logo-a">A</p>
            <p className="Home-logo-r">R</p>
          </div>
        </article>
